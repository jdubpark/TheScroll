<article class="article has-image">
  ...
  <div class="article__body">
    <div class="article__wrapper">
      ...
      <a class="article__image<?php echo get_the_post_thumbnail_url() ? '' : ' no-image'; ?>" href="<?php echo get_the_permalink(); ?>" style="background-image:url('<?php echo get_the_post_thumbnail_url() ?: get_template_directory_uri().'/assets/images/dummy.jpg' ?>')"></a>
    </div>
  </div>
</article>
